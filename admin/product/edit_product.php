        ...
        <div class="card mt-2 mb-5 mx-5" style="border-radius: 50px; box-shadow: 10px 10px 50px rgb(129, 129, 129);">
            ...
            <div class="row mx-4 pt-0">
                <div class="col-md-8 form-floating gx-4">
                    <input type="text" class="form-control" id="floatingInput" name="pro_name"
                        value="<?php echo $product["pro_name"]; ?>" placeholder="name@example.com">
            ...
            <div class="row m-4 gx-4 gy-4">
                <div class="col-md-2 ">
                    <select class="form-select" id="floatingSelect" name="brand">
                        ...
                        <option value="<?php echo $product["brand"]; ?>" selected>
                ...
                <div class="col-md-2">
                    <select class="form-select" id="floatingSelect" name="release_yr">
                        ...
                        <option value="<?php echo $product["release_yr"]; ?>" selected>
                            <?php echo $product["release_yr"]; ?>
                        </option>
                        <?php
                ...
                <div class="col-md-2">
                    <select class="form-select" id="floatingSelect" aria-label="Floating label select example"
                        ...
                        <option value="<?php echo $product["gender"]; ?>" selected>
                ...
                <div class="col-md-2">
                    <select class="form-select" id="floatingSelect" aria-label="Floating label select example"
                        ...
                        <option value="<?php echo $product["top_type"]; ?>" selected>
                            <?php echo $product["top_type"]; ?>
                        </option>
                        <?php
                        if ($top_types = get_top_type()): ?>
                            <?php foreach ($top_types as $top_type): ?>
                                <option value="<?php echo $top_type["id"]; ?>">
                                    <?php echo $top_type["type"]; ?>
                                </option>
                            <?php endforeach; ?>
                        <?php endif; ?>
                    </select>
                ...
                <div class=" col-md-2">
                    <div class="input-group mb-3">
                        <span class="input-group-text" id="basic-addon1"><i class="fa-solid fa-indian-rupee-sign"
            ...
            <div class=" row mx-4 my-2">
                ...
                <textarea class="form-control mx-auto no_resize mx-3 no_resize" placeholder="Description of porduct"
                    id="specification  " name="specification"><?php echo $product["specification"]; ?></textarea>
            ...
            <div class="row mx-4 mb-5 mt-2">
                ...
                <div class="col-md-4 g-4">
                    ...
                    <input type="file" class="form-control col-md-2" id="full_profile" name="full_profile"
                        accept="image/*">
                </div>
                <div class="col-md-4 g-4">
                    <label>Sole</label>
                    <input type="file" class="form-control col-md-2" id="sole_profile" name="sole_profile"
                        accept="image/*">
                </div>
            </div>
            ...
            <div class="position-relative my-5 ">
                ...
                <button type="submit" class="btn btn-warning position-absolute bottom-0 end-0 mx-4 confirm_btn"
                    id="edit_product" name="edit_product" style="border-radius: 30px;"> <i
                        class="fa-regular fa-circle-check pe-2" style="color: #000000;"></i>Confirm</button>
                <a type="button" class="btn btn-secondary bottom-0 start-0 mx-5"
                    href="/admin/product/view_products.php"><i class="fa-solid fa-warehouse px-2"
                        style="color: #ffffff;"></i>Inventory</a>
            </div>
        </div>
    </form>
</div>
