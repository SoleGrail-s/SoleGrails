...
<form role="form" action="<?php echo get_action_attr_value_for_current_page(); ?>" method="post"
    ...
    <div class="card mt-2 mb-5 mx-5" style="border-radius: 50px; box-shadow: 10px 10px 50px rgb(129, 129, 129);">
        ...
        <div class=" row mx-4 my-2">
            ...
            <input class="form-control mx-auto no_resize mx-3 no_resize" placeholder="Description of porduct"
                id="floatingTextarea" name="specification"></input>
        ...
        <div class="position-relative my-5 ">
            ...
            <button type="submit" value="POST" class="btn btn-warning position-absolute bottom-0 end-0 mx-4 confirm_btn"
                style="border-radius: 30px;" name="add_product"> <i class="fa-regular fa-circle-check pe-2"
                    style="color: #000000;"></i>Confirm</button>
            <a type="button" class="btn btn-secondary bottom-0 start-0 mx-5" href="/admin/product/view_products.php"><i
                    class="fa-solid fa-warehouse px-2" style="color: #ffffff;"></i>Inventory</a>
