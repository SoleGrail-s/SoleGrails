...
<div class="container-fluid mt-0">
  ...
  <div class="justify-content-center mx-auto d-grid ">
    <h1 class="lora_font fw-bold card_title">Products
    </h1>

  </div>
  <div class="d-grid justify-content-end mb-3">
    <a href="/admin/product/add_product.php" class="btn btn-light border border-1 border-dark fw-bold btn-sm"><i
        class="fa-solid fa-circle-plus fa-lg px-1 " style="color: #000000;"></i>Add Product</a>
  </div>
  <div class="card mb-5">
    <table class="table ">
      <thead>
        ...
        <?php if ($products = get_products_list()): ?>
          ...
          foreach ($products as $product):
            ...
            <tr class="align-middle gx-5">
              ...
              <td class="text-center">
                <img src="<?php echo substr($product["l_profile"], 26); ?>" class="img-fluid  mx-auto d-block"
