...
<form>
    <div class="card mt-2 mb-5 mx-5" style="border-radius: 50px; box-shadow: 10px 10px 50px rgb(129, 129, 129);">
        ...
        <div class="row mx-4 pt-5">
            <div class="col-md-4">
                <p>Product Id:
                    <b class="border-0 text-center text-muted ps-2" name="product_id" id="product_id">
                        <?php echo $product["id"]; ?>
                    </b>
                </p>
            </div>
            <div class="col-md-4">
                <p>Added Date:<b class="border-0 text-center text-muted ps-2" name="product_id" id="product_id">
                        <?php echo $product["created_timestamp"]; ?>
                    </b></p>
            </div>
            <div class="col-md-4">
                <p>Modified Date:<b class="border-0 text-center text-muted ps-2" name="product_id" id="product_id">
                        <?php echo $product["id"]; ?>
                    </b></p>
            </div>
        ...
        <div class="row m-4 gx-4 gy-4">
            ...
            <div class=" col-md-2">
                ...
                <div><b class="form-control " style="border-color: #00000084; border-radius: 10px;height: 40px; "><i
                            class="fa-solid fa-indian-rupee-sign pe-2" style="color: #000000;"></i>
        ...
        <div class="row mx-4 mb-5 mt-4">
            ...
            <div class="col-md-4 gy-2 gx-4">
                ...
                <img src="<?php echo substr($product["full_profile"], 26); ?>" alt="" class="src" height=200px
                    width=auto>
            </div>
            <div class="col-md-4 gy-2 gx-4">
                <!-- <label>Sole Profile</label> -->
                <img src="<?php echo substr($product["sole_profile"], 26); ?>" alt="" class="src" height=200px
                    width=auto>
            </div>
        </div>
        <div class="position-relative mt-3 mb-5 ">
            <div class="position-absolute bottom-0 end-0 mx-4 gx-2">
                <a type="button" href="/admin/product/edit_product.php?q=<?php echo $product["id"]; ?>"
                    class="btn btn-warning  confirm_btn fw-bold" style="border-radius: 30px;"><i class="fa-solid fa-pen"
                        style="color: #000000;"></i> Edit</a>
                <a type="button" href="/admin/product/view_products.php" class="btn btn-primary  confirm_btn fw-bold"
