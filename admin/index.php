...
<div class="card m-5 border-1"
    ...
    <div class="float-start p-3 text-center">
        ...
        <label class="ms-5 mx-auto my-4 fw-bold card_title"
            style="vertical-align: middle ; font-family: 'Lora', sans-serif; font-size: 30px;">Welcome</label>
    </div>
</div>
<div class="card mx-5 border-1 mb-5"
    ...
    <div class="row align-middle mx-5 mt-3">
        ...
        <div class="col p-3">
            <a href="/admin/orders/view_orders.php" class="txt_dec">
                <button type="button" class=" btn-lg  m-auto fw-bold box_shadow admin_panel_btn">Orders</button>
            </a>
        </div>
    </div>
    <div class="row align-middle mx-5 mb-3">
        <!-- <div class="col p-3">
            <a href="/admin/add_fields.php" class="txt_dec">
                <button type="button" class=" btn-lg  m-auto fw-bold box_shadow admin_panel_btn">Fields</button>
            </a>
