            ...
            <div class="row text-center justify-content-center">
                <div class="col-lg-5">
                    <div class="input-group-md justify-content-center">
                        ...
                        <input class="form-control" type="text" placeholder="Enter new brand" name="new_brand_name"
                            id="new_brand_name" required>
                    </div>
                </div>
                <div class="col-lg-2 mt-4">
                    <button type="submit" id="add_brand" name="add_brand"
                        class="btn btn-warning add_brands_btn px-3 border border-1 box_shadow">Add Brand</button>
                </div>
            </div>
        </form>
    </div>
    <div class=" fw-bold mx-auto d-grid  my-3"
        style="font-size: 30px; text-decoration: underline solid #D87300 5px; border-bottom: 8px;">
        Existing Brand
    </div>
                        ...
                        <tr>
                            ...
                            <td class="text-center">
                                <?php if ($brand["disabled"] === "0"): ?>
                                    <a href="/admin/brands/brand_status?q=<?php echo $brand["brand_id"]; ?>" id="enable"
                                        name="enable"><button type="button" class="btn btn-success btn-sm">Enable</button></a>
                                <?php else: ?>
                                    <a href="/admin/brands/brand_status?q=<?php echo $brand["brand_id"]; ?>" id="disable"
                                        name="disable"><button type="button" class="btn btn-danger btn-sm">Disabled</button></a>
                                <?php endif; ?>
                            </td>
                            <td class="text-center">
