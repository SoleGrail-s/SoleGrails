...
<div class="card mx-5 border-1 mb-5 mt-2"
    ...
    <div class="card-body my-3 mb-5">
        <form role="form" action="<?php echo get_action_attr_value_for_current_page() . "?q=" . $brand["brand_id"]; ?>"
            ...
            <div class="row text-center justify-content-center">
                <div class="col-lg-5">
                    <div class="input-group-md justify-content-center">
                        ...
                        <input class="form-control" type="text" placeholder="Edit Brand" name="brand_name"
                            id="brand_name" value="<?php echo $brand["brand_name"]; ?>" required>
                    </div>
                </div>
                <div class="col-lg-2 mt-4">
                    <button type="submit" id="update_brand" name="update_brand"
                        class="btn btn-warning add_brands_btn px-3 border border-1 box_shadow fw-bold">Update</button>
