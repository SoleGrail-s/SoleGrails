    ...
    <form action="<?php echo get_action_attr_value_for_current_page(); ?>" method="post" enctype="multipart/form-data">
        <div class="card mt-5 mx-4  text-center mx-sm-auto " id="registercard">
            ...
            <div class="row mx-5 mt-5 ">
                <input class=" input-group register_fields input-group-lg register_placeholder" type="text"
                    id="email_id" name="email_id" placeholder="Email-id" required>
                <input class="mt-4 register_fields register_placeholder" type="password" id="password" name="password"
                    placeholder="Password" required>
                <input class="mt-4 my-5 register_fields register_placeholder" type="password" id="confirm_password"
                    name="confirm_password" placeholder="Confirm Password" required>
                <button class="btn btn-dark mx-auto d-grid fw-bold mb-3" name="create_account" id="create_account_btn"
            ...
            <div class=" text-center  my-2">
                <p class="fw-bolder">
                    ...
                    <a href="/login/login">
                        <button class=" btn-warning btn-sm fw-bolder border-1 txt_dec " id="register_btn"
