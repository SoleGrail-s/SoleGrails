...
<div class="card mt-5 mx-4 mb-5 text-center mx-sm-auto " id="logincard">
    ...
    <p class="fw-bolder mb-4">
        ...
        <button class="btn btn-dark btn-sm fw-bold border-0 box_shadow"  type="button" ><a class="expl_btn" href="/explore/index.php">Explore <i class="ps-1 fa-solid fa-dolly fa-lg" style="color: #ffffff;"></i></a></button>
    </p>
    </div>
</div>
<?php
